...
class MainAction extends AdminbaseAction {
	...
	public function cache() {
		...
		if (RUNTIME_PATH_M)
		{
			dir_delete(RUNTIME_PATH_M.'Html/');
			dir_delete(RUNTIME_PATH_M.'Cache/');
			if(is_file(RUNTIME_PATH_M.'~runtime.php'))@unlink(RUNTIME_PATH_M.'~runtime.php');
			if(is_file(RUNTIME_PATH_M.'~allinone.php'))@unlink(RUNTIME_PATH_M.'~allinone.php');	
		}
