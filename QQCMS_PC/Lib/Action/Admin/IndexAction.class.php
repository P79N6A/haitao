...
class IndexAction extends AdminbaseAction
{
	...
	public function main() {
		...
		$qqcms_info=array(
			'qqcms_VERSION'=> VERSION.' '.UPDATETIME.' [ <a href="http://www.qqcms.net" target="_blank">'.L('view_new_VERSION').'</a> ]',			
			'license'=> '<b id="QQCMS_license"></b>',
			'SN'=> '<b id="QQCMS_sn"></b>',
			'update'=>  ' <b id="QQCMS_update"></b>',
			
		);
		$this->assign('qqcms_info',$qqcms_info);
