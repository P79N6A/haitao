...
class Page extends Think {
	...
	public function  show(){
		...
		//$output .= '<a href="'.$this->pageurl($urlrule, 1,$this->parameter).'">'.L('first_page').'</a><span class="current">1</span>';
		if (!$pre_disabled)
		$output .= '<a href="'.$this->pageurl($urlrule, $pre_page,$this->parameter).'">&lt;</a>';
		else
		...
		if (!$next_disabled)
		$output .='<a href="'.$this->pageurl($urlrule,$next_page,$this->parameter).'">&gt;</li>'; 
		else
		$output .='<span class="disabled"> &gt; </span>';
