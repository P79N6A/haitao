...
class Allinpay extends Think {
    ...
    public function __construct($config=array()) {
        ...
        {
            $this->config['gateway_url'] = 'http://ceshi.allinpay.com/gateway/index.do'; //测试
        }
        else
        {
           $this->config['gateway_url'] = 'https://service.allinpay.com/gateway/index.do';
        }
    ...
    public function setup(){
        ...
        */
        ...
        $modules['_config']  = array(
            ...
            array('name' => 'customICP','type' => 'text','value' => $this->config['customICP']),
    ...
    public function get_signMsg(){
        ...
        if ($this->config[orderuserid] == 5482)
        {
            $parameter['merchantId_pc'] = '100020091218001';
        }
        ...
        $paramPay = array(
            ...
            'merchantId'           => $parameter['merchantId_pc'],
