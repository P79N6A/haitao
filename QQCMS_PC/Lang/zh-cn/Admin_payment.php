...
return array(
	...
	'PAY_NOW'=>'立即支付',
	'Allinpay_pay_name' =>  '通联支付',
	'Allinpay_pay_desc' => '通联支付全心致力于联合银行，服务商户，我们通过提供不断创新，度身订制特色服务和产品，为商户打造从传统受理到增值产品的多元化、差异化的银行卡收单服务。<a href="http://www.allinpay.com" target="_blank">立即在线申请</a>',
	'allinpay_account' => '通联支付帐户',
	'allinpay_key' => '交易安全校验码(key)',
	'allinpay_partner' => '合作者身份(parterID)',
	'allinpay_pay_type'  => '选择接口类型',
	'allinpay_pay_type_option1'  => '使用担保交易接口',
	'allinpay_pay_type_option2'  => '使用标准双接口',
	'allinpay_pay_type_option3'  => '使用即时到账交易接口',
	...
	'merchantId_pc' => 'B2C、B2B支付环境商户号',
	'merchantId_m' => '移动支付环境商户号',
	'pickupUrl' => '客户的取货地址',
	'receiveUrl'  => '通知商户网站支付结果的url地址',
	'payType'  => '支付方式',
	'orderCurrency'  => '订单金额币种类型',
	'key'  => 'MD5密钥',

	'CUSTOMS_TYPE' => '海关类别',
	'BIZ_TYPE_CODE' => '业务类型',
	'CUSTOMICP' => '电商对海关接入企业备案号',
	'ESHOP_ENT_CODE' => '电商企业代码（10位海关代码）',
	'ESHOP_ENT_NAME' => '电商企业名称（企业备案的企业全称）',
