...
/*兼容co*/
     ...
     */
    public function __construct($totalRows, $listRows, $parameter = array(), $co) {
    ...
    private function url($page){
        return str_replace(urlencode('[PAGE]'), $page, $this->co.$this->url);/*兼容co*/
    }
