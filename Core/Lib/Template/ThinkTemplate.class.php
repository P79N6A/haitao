...
// +----------------------------------------------------------------------
// $Id: ThinkTemplate.class.php 2791 2012-02-29 10:08:57Z Ivan $
 ...
 * @subpackage  Template
 * @author Ivan <79441928@qq.com>
 * @version  $Id: ThinkTemplate.class.php 2791 2012-02-29 10:08:57Z Ivan $
 +------------------------------------------------------------------------------
 */
class  ThinkTemplate {
    ...
    public function parseTag($tagStr){
        ...
        if('$' == $flag){ //解析模板变量 格式 {$varName}
			...
			// Ivan add 添加if判断
		}elseif(substr($tagStr,0,3)=='if '){  //Ivan add
			...
			return '<?php '.substr($tagStr,4).';?>';  //Ivan add end
