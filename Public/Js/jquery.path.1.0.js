            ...
            $content.css('position', 'relative').children(':first').css('position', 'absolute').click(function() {
                ...
                if ($showmenu.siblings(':animated').size() == 0) {
                    $showmenus.each(function(index) {
                        var $menu = $(this),
		        		x = radius * Math.cos(index * radian / (radian == 360 ? $showmenus.size() : $showmenus.size() - 1) * rad+300),
						y = radius * Math.sin(index * radian / (radian == 360 ? $showmenus.size() : $showmenus.size() - 1) * rad+300);
