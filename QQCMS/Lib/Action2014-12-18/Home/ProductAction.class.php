...
/*秒拍*/
    public function second_beats(){
        ...
        /*取今天商品列表*/
        $today_list=$product->field("id,title,thumb,status,price,url,stock,second_price,en_name,second_star,second_end")->where($where)->order('second_star')->select();
        /*取明天商品列表*/
...
/*拍卖*/
    public function auction(){
        ...
        $this->assign('after_to_small',$after_to_small);
        /*取今天商品列表*/
        $today_list=$product->field("id,title,thumb,status,price,url,stock,start_price,content,en_name,second_star,second_end")->where($where)->order('second_star')->select();
